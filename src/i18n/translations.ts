...
export const translations: Record<string, Entry> = {
  ...
  // --- deal room: meeting scheduler + revenue-split negotiator ---
  'dealRoom.scheduleMeeting': { en: 'Schedule meeting', kn: 'ಸಭೆ ನಿಗದಿಪಡಿಸಿ' },
  'dealRoom.cancelMeeting': { en: 'Cancel meeting', kn: 'ಸಭೆ ರದ್ದುಗೊಳಿಸಿ' },
  'dealRoom.proposeShare': { en: 'Propose revenue split', kn: 'ಆದಾಯ ಹಂಚಿಕೆ ಪ್ರಸ್ತಾಪಿಸಿ' },
  'dealRoom.cancelShare': { en: 'Cancel split', kn: 'ಹಂಚಿಕೆ ರದ್ದುಗೊಳಿಸಿ' },
  'dealRoom.meetingTime': { en: 'Meeting time', kn: 'ಸಭೆಯ ಸಮಯ' },
  'dealRoom.pasteMeetingLink': { en: 'Paste meeting link…', kn: 'ಸಭೆಯ ಲಿಂಕ್ ಅಂಟಿಸಿ…' },
  'dealRoom.dragToTune': { en: 'Drag to tune', kn: 'ಹೊಂದಿಸಲು ಎಳೆಯಿರಿ' },
  'dealRoom.proposedShare': { en: 'Proposed revenue split', kn: 'ಪ್ರಸ್ತಾವಿತ ಆದಾಯ ಹಂಚಿಕೆ' },
  'dealRoom.meetingScheduled': { en: 'Meeting scheduled', kn: 'ಸಭೆ ನಿಗದಿಯಾಗಿದೆ' },
  'dealRoom.joinMeeting': { en: 'Join meeting', kn: 'ಸಭೆಗೆ ಸೇರಿ' },
  'dealRoom.shareNote': { en: 'Proposed a revenue split.', kn: 'ಆದಾಯ ಹಂಚಿಕೆಯನ್ನು ಪ್ರಸ್ತಾಪಿಸಲಾಗಿದೆ.' },

  // --- diligence & verification (lawyer + document summary) ---
  'verify.heading': { en: 'Diligence & verification', kn: 'ಪರಿಶ್ರಮ ಮತ್ತು ಪರಿಶೀಲನೆ' },
  'verify.loading': { en: 'Loading…', kn: 'ಲೋಡ್ ಆಗುತ್ತಿದೆ…' },
  'verify.docTitle': { en: 'Title & document summary', kn: 'ಶೀರ್ಷಿಕೆ ಮತ್ತು ದಾಖಲೆ ಸಾರಾಂಶ' },
  'verify.docSubtitle': { en: 'Prepared by the desk from the parcel’s record set', kn: 'ಭೂಖಂಡದ ದಾಖಲೆಗಳಿಂದ ಡೆಸ್ಕ್ ಸಿದ್ಧಪಡಿಸಿದೆ' },
  'verify.deskReviewed': { en: 'Desk-reviewed', kn: 'ಡೆಸ್ಕ್ ಪರಿಶೀಲಿಸಿದೆ' },
  'verify.ownershipChain': { en: 'Ownership chain', kn: 'ಮಾಲೀಕತ್ವ ಸರಪಳಿ' },
  'verify.encumbrance': { en: 'Encumbrance', kn: 'ಋಣಭಾರ' },
  'verify.taxHistory': { en: 'Tax history', kn: 'ತೆರಿಗೆ ಇತಿಹಾಸ' },
  'verify.katha': { en: 'Katha', kn: 'ಖಾತಾ' },
  'verify.noSummary': { en: 'No document summary on file yet.', kn: 'ಇನ್ನೂ ದಾಖಲೆ ಸಾರಾಂಶ ಇಲ್ಲ.' },
  'verify.legalTitle': { en: 'Legal verification', kn: 'ಕಾನೂನು ಪರಿಶೀಲನೆ' },
  'verify.legalSubtitle': { en: 'Independent due diligence by empanelled counsel', kn: 'ಪಟ್ಟಿಯಲ್ಲಿರುವ ವಕೀಲರಿಂದ ಸ್ವತಂತ್ರ ಪರಿಶ್ರಮ' },
  'verify.verified': { en: 'Verified', kn: 'ಪರಿಶೀಲಿಸಲಾಗಿದೆ' },
  'verify.issuesFound': { en: 'Issues found', kn: 'ಸಮಸ್ಯೆಗಳು ಕಂಡುಬಂದಿವೆ' },
  'verify.advocate': { en: 'Advocate', kn: 'ವಕೀಲರು' },
  'verify.barCouncil': { en: 'Bar Council No.', kn: 'ಬಾರ್ ಕೌನ್ಸಿಲ್ ಸಂ.' },
  'verify.date': { en: 'Verification date', kn: 'ಪರಿಶೀಲನೆ ದಿನಾಂಕ' },
  'verify.remarks': { en: 'Remarks', kn: 'ಟಿಪ್ಪಣಿಗಳು' },
  'verify.noLegal': { en: 'No legal verification on file yet.', kn: 'ಇನ್ನೂ ಕಾನೂನು ಪರಿಶೀಲನೆ ಇಲ್ಲ.' },
  'verify.deskEntry': { en: 'Desk entry', kn: 'ಡೆಸ್ಕ್ ನಮೂದು' },
  'verify.saveDoc': { en: 'Save summary', kn: 'ಸಾರಾಂಶ ಉಳಿಸಿ' },
  'verify.saveLegal': { en: 'Record verification', kn: 'ಪರಿಶೀಲನೆ ದಾಖಲಿಸಿ' },
